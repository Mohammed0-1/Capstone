...
def create_app(test_config=None):
  ...
  def root():
    ...
    return '''<p>Please read the readme file.</p>
    <a href="https://dev-z6rs6ps7.us.auth0.com/authorize?audience=casting_agency&response_type=token&client_id=VB4qQBe6zyO4GeXscN992O8rnHkwbMKV&redirect_uri=http://127.0.0.1:5000/">Oauth Link</a>'''
